  ...
  <MainLayout>
    ...
    <div id="main">
      <Columns>
        ...
        <Card :aspectRatio="16/10">
          <a slot="front" href="detail1.html"><img src="images/pic01.jpg" alt="" /></a>
        </Card>
        <Card :aspectRatio="11/16">
        ...
        <Card :aspectRatio="11/16">
          <a slot="front" href="detail1.html"><img src="images/pic06.jpg" alt="" /></a>
        </Card>
        <Card :aspectRatio="16/10">
        ...
        <Card :aspectRatio="16/10">
          <a slot="front" href="detail1.html"><img src="images/pic09.jpg" alt="" /></a>
        </Card>
        <Card :aspectRatio="11/16">
        ...
        <Card :aspectRatio="11/16">
          <a slot="front" href="detail1.html"><img src="images/pic13.jpg" alt="" /></a>
        </Card>
        <Card :aspectRatio="16/10">
